...
#带空间注意力的图卷积,输入是(B,N,F,T)和(B,N,N),输出是(B,N,F,T)
...
class ASTGCN_block(nn.Module):
    ...
    def forward(self, x):
        ...
        return x_residual, spatial_At, temporal_At  #改,用来可视化

#将时空块堆叠起来，最后接一个卷积层输出预测结果，输入是(B,N,F,T),输出是(B,N,T_out)
class ASTGCN_submodule(nn.Module):
    ...
    def forward(self, x):
        ...
        return output, spatial_at_list, temporal_at_list #改,用来可视化
